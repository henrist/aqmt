...
class HierarchyPlot():
    ...
    def plot(self, outfile, testmeta):
        ...
        def plot_labels(testmeta, x, depth, width):
            #print(testmeta['title'], depth, x, width)
            self.plotutils.gpi += """
...
if __name__ == '__main__':
    ...
    if True:
        ...
        hp.plot('testset-speeds/nonect/testgraph', {
            ...
            'children': [
                {'testcase': 'testset-speeds/nonect/test-001'},
                {'testcase': 'testset-speeds/nonect/test-002'},
                {'testcase': 'testset-speeds/nonect/test-003'},
                {'testcase': 'testset-speeds/nonect/test-004'},
                {'testcase': 'testset-speeds/nonect/test-005'},
                {'testcase': 'testset-speeds/nonect/test-006'},
                {'testcase': 'testset-speeds/nonect/test-007'},
                {'testcase': 'testset-speeds/nonect/test-008'},
                {'testcase': 'testset-speeds/nonect/test-009'},
                {'testcase': 'testset-speeds/nonect/test-010'},
                {'testcase': 'testset-speeds/nonect/test-011'},
                {'testcase': 'testset-speeds/nonect/test-012'},
                {'testcase': 'testset-speeds/nonect/test-013'},
                {'testcase': 'testset-speeds/nonect/test-014'},
                {'testcase': 'testset-speeds/nonect/test-015'},
                {'testcase': 'testset-speeds/nonect/test-016'},
                {'testcase': 'testset-speeds/nonect/test-017'},
            ]
        })
        ...
        hp.plot('testset-speeds/analysis', {
            ...
            'children': [{
                ...
                'children': [
                    ...
                    #    'title': 'tester a',
                    #    'children': [
                    {'testcase': 'testset-speeds/ect1/test-001'},
                    {'testcase': 'testset-speeds/ect1/test-002'},
                    {'testcase': 'testset-speeds/ect1/test-003'},
                    {'testcase': 'testset-speeds/ect1/test-004'},
                    {'testcase': 'testset-speeds/ect1/test-005'},
                    {'testcase': 'testset-speeds/ect1/test-006'},
                    {'testcase': 'testset-speeds/ect1/test-007'},
                    {'testcase': 'testset-speeds/ect1/test-008'},
                    {'testcase': 'testset-speeds/ect1/test-009'},
                    {'testcase': 'testset-speeds/ect1/test-010'},
                    {'testcase': 'testset-speeds/ect1/test-011'},
                    {'testcase': 'testset-speeds/ect1/test-012'},
                    #]},{
                    #    'title': 'Tester noe mer',
                    #    'children': [
                    {'testcase': 'testset-speeds/ect1/test-013'},
                    {'testcase': 'testset-speeds/ect1/test-014'},
                    {'testcase': 'testset-speeds/ect1/test-015'},
                    {'testcase': 'testset-speeds/ect1/test-016'},
                    {'testcase': 'testset-speeds/ect1/test-017'},
                    #]}
                ]
            }]})
