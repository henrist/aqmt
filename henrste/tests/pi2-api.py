    ...
    run_test(
        ...
        steps=(
            ...
            Step.branch_sched([
                ('pi2-1',
                    'PI^2',
                    lambda testbed: testbed.aqm('pi2', 'target 15ms tupdate 15ms alpha 5 beta 50 k 2 t_shift 30ms l_drop 100 l_thresh 3000')),
                ('pi2-2',
                    'PI^2: no\\\\_ecn',
                    lambda testbed: testbed.aqm('pi2', 'no_ecn target 15ms tupdate 15ms alpha 5 beta 50 k 2 t_shift 30ms l_drop 100 l_thresh 3000')),
                ('pi2-3',
                    'PI^2: no\\\\_dualq',
                    lambda testbed: testbed.aqm('pi2', 'no_dualq target 15ms tupdate 15ms alpha 5 beta 50 k 2 t_shift 30ms l_drop 100 l_thresh 3000')),
                ('pi2-4',
                    'PI^2: no\\\\_dualq no\\\\_ecn',
                    lambda testbed: testbed.aqm('pi2', 'no_dualq no_ecn target 15ms tupdate 15ms alpha 5 beta 50 k 2 t_shift 30ms l_drop 100 l_thresh 3000')),
                ('pi2-5',
                    'PI^2: dc\\\\_ecn',
                    lambda testbed: testbed.aqm('pi2', 'dc_ecn target 15ms tupdate 15ms alpha 5 beta 50 k 2 t_shift 30ms l_drop 100 l_thresh 3000')),
                ('pi2-6',
                    'PI^2: dc\\\\_dualq dc\\\\_ecn',
                    lambda testbed: testbed.aqm('pi2', 'dc_dualq dc_ecn target 15ms tupdate 15ms alpha 5 beta 50 k 2 t_shift 30ms l_drop 100 l_thresh 3000')),
            ]),
